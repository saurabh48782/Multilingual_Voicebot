...
REWRITE_SYSTEM = (
    ...
    "EXCEPTION: if the latest query is a meta or conversational question ABOUT the "
    "conversation itself - e.g. what the user asked earlier, which schemes were "
    "discussed, summarize this chat, what was said before - do NOT expand it into a "
    "content lookup. Return such a query UNCHANGED (verbatim), so downstream "
    "classification can recognise it as meta rather than a scheme fact lookup. "
...
CLASSIFY_SYSTEM = (
    ...
    "the assistant itself, meta questions about THIS conversation (what the user asked "
    "earlier, which schemes were discussed so far, summarize this chat), and anything not "
    "seeking NEW factual information about a scheme; "
    ...
    "A question that merely mentions scheme names but asks about what was already said in "
    "the conversation is GENERAL, not SCHEME. "
